 ...
 *
 * - DotNet SDK 연동환경 설정방법 안내 : [개발가이드] - https://developers.popbill.com/guide/sms/dotnet/getting-started/tutorial?fwn=csharp
 * - 업데이트 일자 : 2022-10-26
    ...
    public partial class frmExample : Form
    {
        ...
        */
        ...
        private void btnGetRefundableBalance_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Double refundableBanace = messageService.GetRefundableBalance(CorpNum, UserID);
