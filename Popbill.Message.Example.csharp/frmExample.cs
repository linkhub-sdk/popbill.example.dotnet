...
namespace Popbill.Message.Example.csharp
{
    public partial class frmExample : Form
    {
        ...
        */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetBalance
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetChargeURL
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetPaymentURL
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetUseHistoryURL
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetPartnerBalance
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetPartnerURL
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetUnitCost
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/member#CheckIsMember
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/member#CheckID
         */
        ...
        /*
         * 사용자를 연동회원으로 가입처리합니다.
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/member#JoinMember
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/member#GetAccessURL
         */
        ...
        /*
         * 연동회원의 회사정보를 수정합니다.
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/member#UpdateCorpInfo
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/member#RegistContact
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/member#GetContactInfo
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/member#ListContact
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/member#UpdateContact
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#PaymentRequest
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetPaymentHistory
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetSettleResult
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetUseHistory
         */
        ...
        /**
         * 연동회원 포인트를 환불 신청합니다.
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#Refund
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetRefundHistory
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetRefundInfo
         */
         ...
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/point#GetRefundableBalance
         */
         ...
         * - 관리자 계정만 회원탈퇴가 가능합니다.
         * - https://developers.popbill.com/reference/sms/dotnet/common-api/member#QuitMember
         */
