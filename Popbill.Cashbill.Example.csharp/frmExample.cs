    ...
    public partial class frmExample : Form
    {
        ...
        private void btnGetBulkResult_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tmp += "접수상태 (txState) : " + result.txState + CRLF;
        ...
        private void btnGetInfo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                tmp += "stateDT (상태 변경일시) : " + cashbillInfo.stateDT + CRLF;
                ...
                tmp += "customerName (구매자 성명) : " + cashbillInfo.customerName + CRLF;
                ...
                tmp += "ntsresultCode (국세청 결과코드) : " + cashbillInfo.ntsresultCode + CRLF;
                tmp += "ntsresultMessage (국세청 결과메시지) : " + cashbillInfo.ntsresultMessage + CRLF;
                tmp += "printYN (인쇄여부) : " + cashbillInfo.printYN + CRLF;
                tmp += "interOPYN (연동문서 여부) : " + cashbillInfo.interOPYN + CRLF;
        ...
        private void btnGetInfos_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < cashbillInfoList.Count; i++)
                {
                    ...
                    tmp += "ntsresultCode (국세청 결과코드) : " + cashbillInfoList[i].ntsresultCode + CRLF;
                    tmp += "ntsresultMessage (국세청 결과메시지) : " + cashbillInfoList[i].ntsresultMessage + CRLF;
                    tmp += "printYN (인쇄여부) : " + cashbillInfoList[i].printYN + CRLF;
                    tmp += "interOPYN (연동문서 여부) : " + cashbillInfoList[i].interOPYN + CRLF;
                }
        ...
        private void btnGetDetailInfo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tmp += "customerName (구매자 성명) : " + cashbill.customerName + CRLF;
                tmp += "itemName (주문상품명) : " + cashbill.itemName + CRLF;
                tmp += "orderNumber (주문번호) : " + cashbill.orderNumber + CRLF;
                tmp += "email (구매자 메일) : " + cashbill.email + CRLF;
                tmp += "hp (구매자 휴대폰) : " + cashbill.hp + CRLF;
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetBalance
         *
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetChargeURL
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetPaymentURL
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetUseHistoryURL
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetPartnerBalance
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetPartnerURL
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetChargeInfo
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/member#CheckIsMember
         */
        ...
        /*
         * 사용자를 연동회원으로 가입처리합니다.
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/member#JoinMember
         */
        ...
        /*
         * 연동회원의 회사정보를 확인합니다.
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/member#GetCorpInfo
         */
        ...
        /*
         * 연동회원의 회사정보를 수정합니다.
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/member#UpdateCorpInfo
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/member#RegistContact
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/member#GetContactInfo
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/member#ListContact
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/member#UpdateContact
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetPaymentHistory
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetSettleResult
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetUseHistory
         */
        ...
        /**
         * 연동회원 포인트를 환불 신청합니다.
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#Refund
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetRefundHistory
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetRefundInfo
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/point#GetRefundableBalance
         */
         ...
         * - 관리자 계정만 회원탈퇴가 가능합니다.
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/member#QuitMember
         */
         ...
         * - https://developers.popbill.com/reference/cashbill/dotnet/common-api/member#DeleteContact
         */
        ...
        private void btnDeleteContact_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Response response = cashbillService.DeleteContact(txtCorpNum.Text, ContactID, txtUserId.Text);
