 ...
 *
 * - DotNet C# SDK 연동환경 설정방법 안내 : [개발가이드] - https://developers.popbill.com/guide/easyfinbank/dotnet/getting-started/tutorial?fwn=csharp
 * - 업데이트 일자 : 2022-05-04
...
namespace Popbill.EasyFin.Bank.Example.csharp
{
    public partial class frmExample : Form
    {
        ...
        public void btnGetRefundableBalance_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Double refundableBanace = easyFinBankService.GetRefundableBalance(CorpNum, UserID);
