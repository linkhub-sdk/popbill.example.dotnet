 ...
 *
 * - DotNet C# SDK 연동환경 설정방법 안내 : [개발가이드] - https://docs.popbill.com/bizinfocheck/tutorial/dotnet_csharp
 * - 업데이트 일자 : 2022-09-26
...
namespace Popbill.BizInfoCheck.Example.csharp
{
    public partial class frmExample : Form
    {
         ...
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#GetChargeURL
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#GetPaymentURL
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#GetUseHistoryURL
         */
         ...
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#GetPartnerBalance
         */
         ...
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#GetChargeInfo
         */
         ...
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#CheckIsMember
         */
         ...
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#CheckID
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#GetAccessURL
         */
        ...
        /*
         * 연동회원의 회사정보를 확인합니다.
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#GetCorpInfo
         */
        ...
        /*
         * 연동회원의 회사정보를 수정합니다.
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#UpdateCorpInfo
         */
         ...
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#RegistContact
         */
         ...
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#GetContactInfo
         */
         ...
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#ListContact
         */
         ...
         * - https://docs.popbill.com/bizinfocheck/dotnet/api#UpdateContact
         */
