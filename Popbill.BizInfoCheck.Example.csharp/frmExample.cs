/*
 * 팝빌 기업정보조회 API DotNet SDK Example
 *
 * - DotNet C# SDK 연동환경 설정방법 안내 : [개발가이드] - https://developers.popbill.com/guide/bizinfocheck/dotnet/getting-started/tutorial?fwn=csharp
 * - 업데이트 일자 : 2022-09-26
...
namespace Popbill.BizInfoCheck.Example.csharp
{
    public partial class frmExample : Form
    {
        ...
        private void btnGetRefundableBalance_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Double refundableBanace = bizInfoCheckService.GetRefundableBalance(CorpNum, UserID);
