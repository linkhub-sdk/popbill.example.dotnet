/*
* 팝빌 예금주조회 API .NET SDK C#.NET Example
* C#.NET 연동 튜토리얼 안내 : https://developers.popbill.com/guide/accountcheck/dotnet/getting-started/tutorial?fwn=csharp
*
* 업데이트 일자 : 2025-01-04
...
namespace Popbill.AccountCheck.Example.csharp
{
    public partial class frmExample : Form
    {
        ...
        public void btnGetRefundableBalance_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Double refundableBalance = accountCheckService.GetRefundableBalance(CorpNum, UserID);
